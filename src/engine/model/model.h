...
class model
{
    public:
        ...
        virtual int intersect(int, int, int, const vec &, float, float, float, dynent *, modelattach *, float, const vec &, const vec &) const = 0;
        ...
        virtual void genshadowmesh(std::vector<triangle> &, const matrix4x3 &) const = 0;
